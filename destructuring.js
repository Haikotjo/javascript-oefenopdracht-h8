...
console.log(type + " van het merk " + brand)
...
function getSizes() {
  return [41, 43, 46, 56, 65]
}
const [sizeOne, sizeTwo, sizeThree, sizeFour, sizeFive] =getSizes()
console.log(sizeOne + " en " + sizeThree)

const [first,, third,, lol] = tvSizes;
console.log(first, third, lol);
...
const [firstOne, secondOne] = getDetails("Haiko", 39)
